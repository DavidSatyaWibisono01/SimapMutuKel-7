      ...
      <table class="table table-hover bulk_action">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>{{$prtn->question}}</td>
                <td class="ckk-question"><a href="/hasil-evaluasi-individu-c-karya-inovatif/edit/{{$prtn->id}}" ><i class="fi fi-rr-edit"></i></a></td>
                <form action="/hasil-evaluasi-individu-c-karya-inovatif/delete/{{$prtn->id}}" method="post">
                    @method('delete')
                    @csrf
