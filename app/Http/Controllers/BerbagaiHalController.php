...
class BerbagaiHalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('hasil-evaluasi-individu-a-berbagai-hal')->with('simpan', 'pertanyaan Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, Pertanyaan $pertanyaan)
    {
        ...
        Pertanyaan::where('id', $pertanyaan->id)
            ->update([
                ...
                return redirect('hasil-evaluasi-individu-a-berbagai-hal')->with('update', 'pertanyaan Berhasil Diubah');
    }
    ...
    public function destroy(Pertanyaan $pertanyaan)
    {
        ...
        return redirect('/hasil-evaluasi-individu-a-berbagai-hal')->with('hapus', 'Data Berhasil Dihapus');
    }
}
